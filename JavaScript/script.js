...
function validateform() {
 ...
 if(nameVal.length < 2 || nameVal.length > 22) {
   // Error Code here
     ...
     document.getElementById("nameError").insertAdjacentHTML("afterend",
  ...
  if(emailVal.length < 11 || emailVal.length > 30 || !address.contains("@")) {
    ...
    document.getElementById("emailError").insertAdjacentHTML("afterend",
  ...
  if(messageVal.length < 10 || messageVal.length > 150 ) {
    // Error Code here
     ...
     document.getElementById("msgError").insertAdjacentHTML("afterend",
